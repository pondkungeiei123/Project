...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['user_Certificate'])) {
        ...
        if (move_uploaded_file($certificate_temp, $target_directory . $target_file)) {
            ...
            $sql = "INSERT INTO user_table (user_name, user_lastname, user_birthdate, user_age, user_gender, user_idcard, user_email, user_password, user_address, user_nationality, user_religion, user_phone, user_Certificate)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
